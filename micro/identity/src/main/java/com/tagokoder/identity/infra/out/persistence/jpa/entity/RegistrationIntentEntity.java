...
public class RegistrationIntentEntity {
    ...
    @Column(name = "id_document_front_bucket", nullable = false)
    private String idDocumentFrontBucket;

    @Column(name = "id_document_front_key", nullable = false)
    private String idDocumentFrontKey;

    @Column(name = "selfie_bucket", nullable = false)
    private String selfieBucket;

    @Column(name = "selfie_key", nullable = false)
